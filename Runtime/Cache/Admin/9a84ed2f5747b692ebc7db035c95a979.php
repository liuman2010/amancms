						...
						<div class="row">
							<div class="col-xs-12">
								<select  class='form-control select_column'>
									...
									<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><option value="<?php echo ($list["tables_in_amancms"]); ?>" class="form-control">在<?php echo ($list["tables_in_amancms"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
								</select>

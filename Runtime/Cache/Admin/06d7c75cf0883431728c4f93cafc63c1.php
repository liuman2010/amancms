	...
	<div class="col-sm-12">
		<div class="col-sm-11">
				...
				<table class='table   table-bordered  table-hover'>
						<caption></caption>
						<tr>
							<th><a class='all_select'>全选</a></th><th>栏目名称</th><th>栏目简介</th><th>是否显示</th><th>创建时间</th><th>操　　作</th>
						</tr>
						

					<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><tr>
							<td style="width:80px;"><input id='id' type="checkbox" class='id' name='ids[]' value='<?php echo ($list["id"]); ?>' /></td>

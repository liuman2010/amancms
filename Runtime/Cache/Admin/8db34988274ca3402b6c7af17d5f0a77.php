		...
		<table class="table table-bordered ">
		   ...
		   <tbody>
		      ...
		      <tr>
		         ...
		         <td>
		         	<p>
		         		<label>&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="WATER_POSITION" class="p7" value="7">顶部左上</label>
		         		<label>&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="WATER_POSITION" class="p8" value="8">顶部居中</label>
		         		<label>&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="WATER_POSITION" class="p9" value="9">顶部右上</label>
		         	</p>
		         	<p>
		         		<label>&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="WATER_POSITION" class="p4" value="4">中部左边</label>
		         		<label>&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="WATER_POSITION" class="p5" value="5">中部居中</label>
		         		<label>&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="WATER_POSITION" class="p6" value="6">中部右边</label>
		         	</p>
		         	<p>
		         		<label>&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="WATER_POSITION" class="p1" value="1">底部左边</label>

...
//	var hz6d_block_trace_over = false;
		...
		if(hz6d_get_guest_id_over==0 && hz6d_get_guest_id_num>0){
			...
			if(hz6d_guest_id!="" && hz6d_guest_id>0) {
				if(hz6d_cus_web_msg_gids.indexOf(hz6d_guest_id)>=0){
					var url = "http://www15.53kf.com/lword_reply.php?company_id=72124654&guest_id="+hz6d_guest_id;
    ...
    */
	...
	function hz6d_cus_web_msg_open(){
		var openurl = "http://www15.53kf.com/webCompany.php?arg=10124654&style=1&kflist=off&kf=qby53kf2%40163.com&zdkf_type=1&language=cn&charset=gbk&username=&userinfo=&introurl=&lyurl=&lytype=0&copartner=&referer=http%3A%2F%2Fwww.qbypj7.com%2Fa%2Fshipinyanshi%2F&keyword=&brief=&logo=&question=";
		try{
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
			...
			var zdyivt						= "0";
			var ivtstr						= "<div id=\"acc_title\" class=\"Lelem\" style=\"    position: relative; z-index: 10000;\" minheight=\"100\" minwidth=\"100\" maxheight=\"400\" maxwidth=\"400\"><div class=\"Lelem\" type=\"img\" style=\"display: block; cursor: default; position: absolute; top: 49px; left: 6px; z-index: 10001; width: 383px; height: 197px;\"><img style=\"width: 383px; height: 197px;\" src=\"http://www15.53kf.com/style/setting/ver06/img/icon/logo-skin/common_bg_inv/commonbg_15.png\"></div><div style=\"display: block; cursor: default; position: relative; top: 56px; left: 43px; z-index: 10002; width: 100px; height: 20px; color: rgb(255, 255, 255);\" type=\"text\" class=\"Lelem\"><span style=\"vertical-align: top; color: rgb(255, 255, 255); font-family: 宋体; font-size: 14px; line-height: 20px;\" iseditable=\"1\">仟变源牌具</span></div><div style=\"display: block; cursor: pointer; position: absolute; top: 66px; left: 365px; z-index: 10003; width: 10px; height: 8px;\" operating=\"CLOSE\" type=\"img\" class=\"Lelem\"><img src=\"http://www15.53kf.com/style/setting/ver06/img/icon/logo-skin/close_btn/closebtn_4.png\" style=\"width: 10px; height: 8px;\"></div><div style=\"display: block; cursor: default; position: absolute; top: 89px; left: 24px; z-index: 10004; width: 100px; height: 93px;\" type=\"img\" class=\"Lelem\"><img src=\"http://www15.53kf.com/style/setting/ver06/img/icon/logo-skin/other_img/otherimg_12.png\" style=\"width: 100px; height: 93px;\"></div><div class=\"Lelem\" type=\"img\" operating=\"KF\" style=\"display: block; cursor: pointer; position: absolute; top: 196px; left: 133px; z-index: 10008; width: 104px; height: 31px;\"><img style=\"width: 104px; height: 31px;\" src=\"http://www15.53kf.com/style/setting/ver06/img/icon/logo-skin/click_btn/clickbtn_42.png\"></div><div class=\"Lelem\" type=\"text\" operating=\"CLOSE\" style=\"display: block; cursor: pointer; position: absolute; top: 204px; left: 258px; z-index: 10009; width: 60px; height: 17px; color: rgb(255, 255, 255);\"><span iseditable=\"1\" style=\"vertical-align: top; text-decoration: underline; font-size: 12px; line-height: 17px; color: rgb(255, 209, 184); font-family: 宋体;\">下次再说</span></div><div class=\"Lelem\" type=\"text\" style=\"display: block; cursor: pointer; position: absolute; top: 89px; left: 122px; z-index: 10006; width: 162px; height: 22px;\" operating=\" \"><span iseditable=\"1\" style=\"vertical-align: top; font-weight: bold; font-size: 15.4px;\">仟变源牌具欢迎您！</span></div><div class=\"Lelem\" type=\"text\" style=\"display: block; cursor: pointer; position: absolute; top: 113px; left: 121px; z-index: 10007; width: 267px; height: 20px;\" operating=\"null\"><span iseditable=\"1\" style=\"vertical-align: top; font-size: 14px;\">主要经营各种高科技牌具：普通扑克分析仪、白光隐形眼镜、变牌器等娱乐产品，全国各地货到付款！热线：13924296622</span></div></div>";
			var is_autoyqk				= "1";
			...
			$53.creElm({
            	...
            	frameBorder:0,
            	src:'http://www15.53kf.com/minkh/hz6d_iframe_proxy2.html?from{' + window.location.href.split('#6d')[0] + '}morf#hz6d{data:""}d6zh&ver=20121128002'
            }, "iframe");
			...
			{
				var openurl = "http://www15.53kf.com/webCompany.php?arg=10124654&style=1&kflist=off&kf=qby53kf2%40163.com&zdkf_type=1&language=cn&charset=gbk&username=&userinfo=&introurl=&lyurl=&lytype=0&copartner=&referer=http%3A%2F%2Fwww.qbypj7.com%2Fa%2Fshipinyanshi%2F&keyword=&brief=&logo=&question=&tfrom=2"+force_kf;
				try{
			...
			{
				if(acc_poptype==1) {
					document.cookie = "onliner_zdfq72124654="+onliner_zdfq;
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
				...
				try{
					...
					if(type==1){
						...
						acpt_force_kf(force_kf);
							...
							$53("iframe_company_mini").src = openurl_mini + tpl + '&timeStamp=' + new Date().getTime()+'&interface_color=1&interface_theme=3&minchat_style=1';
			...
			function close_company_mini(){
				if(acc_autotype == 3) {document.cookie = "onliner_zdfq72124654="+onliner_zdfq;}
			...
			function ivt_seturl(zdy_yqk)
			{
				var divs_str = zdy_yqk.replace(/operating="([^"]*)"/g,function(str){
					...
					if(vals[1])
					{
						...
						{
							case 'KF': 
								case 'KF': var click_open_url = 'window.open(\"http://www15.53kf.com/webCompany.php?arg=10124654&style=1&kflist=off&kf=qby53kf2%40163.com&zdkf_type=1&language=cn&charset=gbk&username=&userinfo=&introurl=&lyurl=&lytype=0&copartner=&referer=http%3A%2F%2Fwww.qbypj7.com%2Fa%2Fshipinyanshi%2F&keyword=&brief=&logo=&question=&tfrom=2\",\"_blank\",\"height=473,width=703,top=200,left=200,status=yes,toolbar=no,menubar=no,resizable=yes,scrollbars=no,location=no,titlebar=no\")';
								click_open_url = encodeURIComponent(click_open_url);
								click_str ='onliner_zdfq=2;hz6d_is_exist(\"'+click_open_url+'\");hidden_ivt();';break;
								//click_str ='onliner_zdfq=2;get_open_start();window.open(\"http://www15.53kf.com/webCompany.php?arg=10124654&style=1&kflist=off&kf=qby53kf2%40163.com&zdkf_type=1&language=cn&charset=gbk&username=&userinfo=&introurl=&lyurl=&lytype=0&copartner=&referer=http%3A%2F%2Fwww.qbypj7.com%2Fa%2Fshipinyanshi%2F&keyword=&brief=&logo=&question=&tfrom=2\",\"_blank\",\"height=473,width=703,top=200,left=200,status=yes,toolbar=no,menubar=no,resizable=yes,scrollbars=no,location=no,titlebar=no\");hidden_ivt();';break;
							case 'CLOSE': click_str = 'onliner_zdfq=3;hidden_ivt();'; break;
							case 'ETEL': click_str = 'window.open(\'http://tb.53kf.com/eht.php?company_id=72124654&style_id=106166976\',\'_blank\',\'height=400,width=300,top=100,left=200,status=yes,toolbar=no,menubar=no,resizable=no,scrollbars=no,location=no,titlebar=no\')'; break;
							case 'QQ': 
								if(valst[1])
								{
